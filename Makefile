...
settings: $(SITE_ROOT)/settings/local.py $(SITE_ROOT)/settings/local_test.py
...
# Uncomment the next line to enable node tests in CI
...
psql:
	docker-compose exec postgres psql --user test --dbname test
